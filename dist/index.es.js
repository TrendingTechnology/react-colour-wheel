...
var ColourWheel = function (_Component) {
  inherits(ColourWheel, _Component);

  function ColourWheel() {
    classCallCheck(this, ColourWheel);

    var _this = possibleConstructorReturn(this, (ColourWheel.__proto__ || Object.getPrototypeOf(ColourWheel)).call(this));
  ...
  createClass(ColourWheel, [{
    ...
    value: function outerWheelClicked(evtPos) {
      ...
      var _rgbaArr = slicedToArray(rgbaArr, 3),
          r = _rgbaArr[0],
          g = _rgbaArr[1],
          b = _rgbaArr[2];
    ...
    value: function innerWheelClicked(evtPos) {
      ...
      var _rgbaArr2 = slicedToArray(rgbaArr, 3),
          r = _rgbaArr2[0],
          g = _rgbaArr2[1],
          b = _rgbaArr2[2];
